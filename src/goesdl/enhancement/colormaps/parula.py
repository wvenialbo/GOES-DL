...
#
# NOTE: This is a copy of the new Parula colourmap from MATLAB R2019b.
# The old Parula colourmap from R2016b and earlier releases can be found
# in the `parolinum` module
#
...
_cm_name = "parula"
_cm_data = to_float(_parula_data)

parula = make_cmap(_cm_name, _cm_data, ncolors=256)

register_cmap(parula, name=_cm_name)
